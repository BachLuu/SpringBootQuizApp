...
public interface QuizHistoryApi {
	...
	@Operation(summary = "Get my history", description = "Get the authenticated user's quiz attempt history")
	...
	ResponseEntity<List<QuizSessionSummaryResponse>> getMyHistory(UserDetails userDetails);

	@Operation(summary = "Get my history (paginated)",
			description = "Get the authenticated user's quiz attempt history with pagination")
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "History retrieved successfully") })
	...
	@Operation(summary = "Get user's history (Admin)",
			description = "Get a specific user's quiz attempt history (admin only)")
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "History retrieved successfully"),
			@ApiResponse(responseCode = "204", description = "No quiz attempts found"),
